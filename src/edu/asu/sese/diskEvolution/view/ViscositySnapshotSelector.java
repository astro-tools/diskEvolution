...
public class ViscositySnapshotSelector implements Observer, ChangeListener {
    
    private JSlider slider;
    private ViscositySnapshotCollection collection;
    private SimpleObservable observable = new SimpleObservable();

    ViscositySnapshotSelector(ViscositySnapshotCollection collection) {
