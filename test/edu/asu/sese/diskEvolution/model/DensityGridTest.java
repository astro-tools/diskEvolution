...
public class DensityGridTest {
    ...
    @Test
    public void testCopyConstructorConservesMass() {
        grid.initializeWithPowerLaw(density0, rmin, 1.0);
        DensityGrid newGrid = new DensityGrid(grid);
        assertEquals(grid.getTotalMass(), newGrid.getTotalMass(), 1e10);
    }
